...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['line_token', 'fullname', 'avatar', 'position', 'auth_key'], 'string'],
    ...
    public static function findByUsernameByMail($email)
    {
        return static::findOne(['email' => $email, 'status' => self::STATUS_ACTIVE]);
    }

    public static function findByUsernameByLine($verify)
    {
        return static::findOne(['line_token' => $verify, 'status' => self::STATUS_ACTIVE]);
    }
